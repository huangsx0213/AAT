...
class Execution_UI(object):
    ...
    def setup_execution_main_tab(self):
        ...
        # 2.define a gridlayout
        self.execution_action_gridlayout = QGridLayout()
        self.execution_action_gridlayout.setContentsMargins(3, 2, 1, 3)
        ...
        self.execution_action_gridlayout.addWidget(self.execution_main_tab_toolbar, 0, 0)
        self.execution_action_gridlayout.addWidget(self.execution_tabwidget, 1, 0)
        # add the gridlaout into the groupbox
        self.execution_groupbox.setLayout(self.execution_action_gridlayout)
        ...
        self.execution_action_gridlayout = QGridLayout()
        self.execution_action_gridlayout.setContentsMargins(0, 0, 0, 0)
        self.all_executions_tab.setLayout(self.execution_action_gridlayout)
        self.execution_action_gridlayout.addWidget(self.execution_tableview)
        ...
        self.testset_gridlayout.addWidget(self.testset_tableview)
    ...
    def setup_execution_actions_column(self):
        ...
        self.execution_action_gridlayout = QGridLayout()
        self.execution_action_gridlayout.setContentsMargins(3, 3, 3, 3)
        self.execution_action_widget.setLayout(self.execution_action_gridlayout)
        ...
        self.execution_action_gridlayout.addWidget(self.execution_edit_button, 0, 0)
        self.execution_action_gridlayout.addWidget(self.execution_delete_button, 0, 1)
